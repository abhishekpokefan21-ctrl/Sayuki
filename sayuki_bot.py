...
# --- 🖼️ PERSONA IMAGES (PASTE YOUR LINKS HERE) ---
# Get these links by uploading images to Discord and right-clicking "Copy Link"
PERSONA_URLS = {
    "sayuki": "https://cdn.discordapp.com/attachments/123/sayuki_pfp.png", # <--- REPLACE THIS
    "kusanagi": "https://cdn.discordapp.com/attachments/123/kusanagi_pfp.png", # <--- REPLACE THIS
    "yumiko": "https://cdn.discordapp.com/attachments/123/yumiko_pfp.png", # <--- REPLACE THIS
    "xeni": "https://cdn.discordapp.com/attachments/123/xeni_pfp.png" # <--- REPLACE THIS
}
...
async def send_smart_message(destination, text):
    ...
    try:
        ...
        if current_mode == "sayuki":
            p_name = "Sayuki 💋"
            p_avatar = PERSONA_URLS["https://res.cloudinary.com/drlvdpibe/image/upload/v1763926273/6219d062ee15c558692f02e4c35c5a3c_b0d5mp.jpg"]
        elif current_mode == "kusanagi":
            p_name = "Kusanagi 🍵"
            p_avatar = PERSONA_URLS["https://res.cloudinary.com/drlvdpibe/image/upload/v1763924687/1dbc63c2c8ca0f654c99de63d461dee0_dirz6t.jpg"]
        elif current_mode == "yumiko":
            p_name = "Yumiko 👉👈"
            p_avatar = PERSONA_URLS["https://res.cloudinary.com/drlvdpibe/image/upload/v1763924689/kitagawa-kitagawa-marin_gcc2mx.gif"]
        elif current_mode == "xeni":
            p_name = "Xeni 💀"
            p_avatar = PERSONA_URLS["https://res.cloudinary.com/drlvdpibe/image/upload/v1763925512/612b292a8ba3106dde7d8ed0e7aef5d4_jegcub.jpg"]
        else:
            p_name = client.user.display_name
            p_avatar = client.user.display_avatar.url
